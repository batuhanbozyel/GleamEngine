...
GENUM(TextureFormat, "B87B25FD-841E-45C8-A2D4-27540B268A52", Serializable)
{
	...
	GITEM(R32G32B32A32_SFloat, "AD52E31E-5C9D-4E61-AAEC-BC55731C16E5"),

	GITEM(B8G8R8A8_SRGB, "7A8B9C0D-1E2F-41D3-9E4F-5A6B7C8D9E0F"),
	GITEM(B8G8R8A8_UNorm, "44335B3C-8562-426B-89E6-A06EC667D09F"),
	...
	GITEM(D32_SFloat, "E2C6C56F-25DE-4E8D-B826-4434CCA34CFD"),
	GITEM(D24_UNorm_S8_UInt, "9A0B1C2D-3E4F-45D5-9E6F-7A8B9C0D1E2F"),
	GITEM(D32_SFloat_S8_UInt, "1C9B0FA5-835F-455E-8416-7550817988A6")
};
