...
#define VISIBILITY_RESOLVE_GROUP_SIZE 32u
...
#define MAX_MESH_INSTANCES   65536u
#define INSTANCE_MASK_UINTS  (MAX_MESH_INSTANCES / 32u)
#define PICKING_GROUP_SIZE_X 8u
#define PICKING_GROUP_SIZE_Y 8u
