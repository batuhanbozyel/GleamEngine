...
- Opacity Micromap Array addresses alignment was validated too strictly to 256B.
  Fixed to `D3D12_RAYTRACING_OPACITY_MICROMAP_ARRAY_BYTE_ALIGNMENT`: 128B.
  No effect on runtime behavior, just a debug layer message fix.
